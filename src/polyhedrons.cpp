...
public:
    ...
    {        
        ...
        compound.add_shape(edyn::box_shape{0.1, 0.5, 0.1}, {-0.5, 0, 0}, edyn::quaternion_identity);
        compound.add_shape(edyn::box_shape{0.1, 0.5, 0.1}, {0.5, 0, 0}, edyn::quaternion_identity);
        compound.add_shape(edyn::box_shape{0.1, 0.5, 0.1}, {0.0, 0, 0}, edyn::quaternion_axis_angle(edyn::normalize(edyn::vector3{0, 0, 1}), edyn::pi * 0.5));
        compound.finish();
        ...
        dyn_def.position = {0, 1.3, 0.0};
        dyn_def.orientation = edyn::quaternion_axis_angle(edyn::normalize(edyn::vector3{1, 0, 1}), edyn::pi * -0.75);
        edyn::make_rigidbody(*m_registry, dyn_def);
